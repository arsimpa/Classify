...
final class HttpClient {
    ...
    init(baseUrl: String = BASE_URL, session: URLSessionProtocol = URLSession.shared) {
...
//    }
    ...
    func load(path: String, method: RequestMethod, params: JSON, completion: @escaping (Any?, ServiceError?) -> ()) -> URLSessionDataTaskProtocol? {
        ...
        // Adding common parameters like APPID, Token to all requests
        // Change into var before adding
        let parameters = params
        
        // Example usage
//        if let token = AppID.token {
